        ...
        <div className="grid gap-4 lg:grid-cols-[1fr_340px]">
                ...
                {users.map((user) => (
                  <div key={user.id} className="rounded-3xl border border-[#2a2d3a] bg-[#0f1117] p-4">
                    ...
                    <div className="mt-3 grid gap-2 text-sm text-slate-400">
                      <p>Websites: {user.websites.length}</p>
          ...
          <div className="rounded-3xl border border-[#2a2d3a] bg-[#13151f] p-6">
            ...
            <p className="text-sm leading-6 text-slate-400">
              Only users with the role <span className="text-white">admin</span> or <span className="text-white">superadmin</span> can access this page. You can use the backend role management API to grant or revoke roles for users.
            </p>
